package com.salesianostriana.goldtowerhotel.config;
...
@Configuration
@EnableJpaRepositories(basePackages={"com.salesianostriana.goldtowerhotel"})
...
public class JpaConfig implements DisposableBean {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        lcemfb.setPackagesToScan(new String[] {"com.salesianostriana.goldtowerhotel"});
