...
public interface HabitacionRepository extends JpaRepository<Habitacion, Long> {
	...
	/*
	 * Consulta que selecciona las habitaciones que sean del tipo que indique el
	 * usuario y que no estén reservadas en el intervalo de tiempo también indicado.
	 */
	...
	Iterable<Habitacion> findHabitacionesNoReservadas(@Param("inicio") LocalDate inicio, @Param("fin") LocalDate fin,
